...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :puppet do |puppet|
    puppet.vm.network "public_network", ip: "10.24.0.10" 
  ...
  config.vm.define :web do |web|
    web.vm.network "public_network", ip: "10.24.0.11" 
  ...
  config.vm.define :db do |db|
    db.vm.network "public_network", ip: "10.24.0.12"
  ...
  config.vm.define :zbs do |zbs|
    zbs.vm.network "public_network", ip: "10.24.0.13"
  ...
  config.vm.define :zdb do |zdb|
    zdb.vm.network "public_network", ip: "10.24.0.14"
